  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-20 fade-in">
      ...
      {isRecording ? (
        ...
        <button
          onClick={onSkip}
          className="mt-6 px-6 py-2 rounded-full border border-hairline text-[13px] text-whisper
                     transition-colors duration-200 hover:border-red-400 hover:text-red-500 hover:bg-red-50"
        >
          Skip speaking
        </button>
      )}
